...
static void ddrtbl_load(void)
{
	...
	{
		_tblcopy(_cnf_DDR_PHY_SLICE_REGSET,
			DDR_PHY_SLICE_REGSET_G2N, DDR_PHY_SLICE_REGSET_NUM_G2N);
		_tblcopy(_cnf_DDR_PHY_ADR_V_REGSET,
			DDR_PHY_ADR_V_REGSET_G2N, DDR_PHY_ADR_V_REGSET_NUM_G2N);
		_tblcopy(_cnf_DDR_PHY_ADR_I_REGSET,
			DDR_PHY_ADR_I_REGSET_G2N, DDR_PHY_ADR_I_REGSET_NUM_G2N);
		_tblcopy(_cnf_DDR_PHY_ADR_G_REGSET,
			DDR_PHY_ADR_G_REGSET_G2N, DDR_PHY_ADR_G_REGSET_NUM_G2N);
		_tblcopy(_cnf_DDR_PI_REGSET,
			DDR_PI_REGSET_G2N, DDR_PI_REGSET_NUM_G2N);
	...
	if (((Prr_Product == PRR_PRODUCT_G2M) || (Prr_Product == PRR_PRODUCT_G2N)) &&
...
static uint32_t set_term_code(void)
{
	...
	while (1)
	{
		...
		if ((TermcodeBySample[index][0] == chip_id[0]) && (TermcodeBySample[index][1] == chip_id[1]))
		{
	...
	else if ((Prr_Product == PRR_PRODUCT_G2M) && (Prr_Cut == PRR_PRODUCT_10))
	{
		/* non */
	}
	else
